...
Insert: Add a new node to the linked list
Delete: Remove a node from the start of the linked list
Print: Display the shapes and its details
Exit: Exit the program

Note - the template classes are implemented in the header file and don't have source files,
